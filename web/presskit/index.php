...
foreach( $xml->children() as $child )
{
	switch( $child->getName() )
	{
		...
		case("website"):
			...
			break;
		case("website-label"):
			define("COMPANY_WEBSITE_LABEL", $child);
			break;
		case("press-contact"):
		...
		<div class="uk-container uk-container-center">
			<div class="uk-grid">
				<div id="navigation" class="uk-width-medium-1-4">
					...
					<a class="nav-header" href="'. parseLink(COMPANY_WEBSITE) .'">'. COMPANY_WEBSITE_LABEL .'</a>
...
}else if( file_exists("images/header.gif") ) {
...
echo '							<h2 id="features">'. tl('Features') .'</h2>
							<ul>';
...
echo '<div class="uk-width-medium-1-2"><a href="images/logo-transparent.png"><img src="images/logo-transparent.png" alt="logo" /></a></div>';
echo '<div class="uk-width-medium-1-2"><a href="images/logo-shadow.png"><img src="images/logo-shadow.png" alt="logo" /></a></div>';
echo '<div class="uk-width-medium-1-2"><a href="images/logo.gif"><img src="images/logo.gif" alt="logo" /></a></div>';
echo '<div class="uk-width-medium-1-2"><a href="images/logo-square.gif"><img src="images/logo-square.gif" alt="logo" /></a></div>';
